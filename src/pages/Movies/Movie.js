...
const Movie = () => {
  ...
  const fetchPopularMovie = async () => {
    const res = await axios.get(
      `${apiConfig.baseUrl}discover/movie?api_key=${apiConfig.apikey}&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=${page}&with_genres=${genreURL}`
    );
